...
export default {
  ...
  data () {
    return {
      tableColumns: [],
      pomainColumns: [
        {id: 'poId', label: '采购单编号', width: ''},
        {id: 'venderName', label: '供应商名称', width: ''},
        {id: 'createTime', label: '创建日期', width: ''},
        {id: 'account', label: '创建用户', width: ''},
        {id: 'poTotal', label: '采购单总金额', width: ''},
      ],
      somainColumns: [
        {id: 'soId', label: '销售单号', width: ''},
        {id: 'customerCode', label: '客户编号', width: ''},
        {id: 'customerName', label: '客户名称', width: ''},
        {id: 'createTime', label: '销售日期', width: ''},
        {id: 'account', label: '经手人', width: ''},
        {id: 'soTotal', label: '销售单总金额', width: ''},
        {id: 'prePayFee', label: '未付款金额', width: ''},
      ],
      receiptColumns: [
        {id: 'soid', label: '销售单编号', width: ''},
        {id: 'createTime', label: '销售单日期', width: ''},
        {id: 'pay_time', label: '收款日期', width: ''},
        {id: 'pay_price', label: '收款金额', width: ''},
        {id: 'account', label: '经手人', width: ''},
      ],
      payColumns: [
        {id: 'poid', label: '采购单号', width: ''},
        {id: 'createTime', label: '采购日期', width: ''},
        {id: 'pay_time', label: '付款日期', width: ''},
        {id: 'pay_price', label: '付款金额', width: ''},
        {id: 'account', label: '经手人', width: ''},
      ],
      instockColumns: [
        {id: 'poId', label: '采购单号', width: ''},
        {id: 'stockTime', label: '入库日期', width: ''},
        {id: 'productCode', label: '产品编号', width: ''},
        {id: 'name', label: '产品名称', width: ''},
        {id: 'stockNum', label: '产品数', width: ''},
        {id: 'productTotal', label: '产品总金额', width: ''},
      ],
      outstockColumns: [
        {id: 'soId', label: '销售单号', width: ''},
        {id: 'stockTime', label: '出库日期', width: ''},
        {id: 'productCode', label: '产品编号', width: ''},
        {id: 'name', label: '产品名称', width: ''},
        {id: 'stockNum', label: '产品数', width: ''},
        {id: 'productTotal', label: '产品总金额', width: ''},
